...
//Thực thi chuỗi truy vấn trong CSDL
...
//Lấy dữ liệu 1 bản ghi trong CSDL
function db_fetch_assoc($query_string) {
    global $conn;
...
//Hàm chèn, thêm dữ liệu trong CSDL
...
//Hàm thoát các ký tự đặc biệt trong chuỗi để sử dụng câu lệnh try vấn CSDL
