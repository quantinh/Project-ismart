...
<div id="main-content-wp" class="add-cat-page menu-page">
    <div class="section" id="title-page">
        <div class="clearfix">
            <a href="?mod=menus&controller=index&action=index" title="Thêm menu" id="add-new" class="fl-left">Thêm mới</a>
                    ...
                    <?php echo form_error('menu'); ?>
                        <form  method="POST" action="?mod=menus&controller=index&action=addMenu">
                            <div class="form-group">
                                ...
                                <input type="text" name="menu_title" id="title" value="<?php echo get_inf_menu('menu_title', $menu_id); ?>">
                            </div>
                            <p class='mess_error'><?php echo form_error('menu_title'); ?></p>

                            <div class="form-group">
                                <label for="url-static">Đường dẫn tĩnh</label>
                                <input type="text" name="menu_url_static" id="url-static" value="<?php echo get_inf_menu('menu_url_static',  $menu_id); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="menu_order" min="1" max="100" id="menu-order" value="<?php echo get_inf_menu('menu_order', $menu_id); ?>">
                            </div>
