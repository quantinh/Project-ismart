...
$list_admins = db_search_admins_by_page($value, $start, $num_per_page);

#Tổng bài viết đã phê duyệt
$total_approved = db_num_rows("SELECT * FROM `tbl_admins` WHERE `admin_status` = 'Approved' AND `username` LIKE '%$value%' OR `fullname` LIKE '%$value%'");

#Tổng bài viết chờ xét duyệt
$total_waiting = db_num_rows("SELECT * FROM `tbl_admins` WHERE `admin_status` = 'Waiting...' AND `username` LIKE '%$value%' OR `fullname` LIKE '%$value%'");

#Tổng bài viết đã xóa
$total_trash = db_num_rows("SELECT * FROM `tbl_admins` WHERE `admin_status` = 'Trash' AND `username` LIKE '%$value%' OR `fullname` LIKE '%$value%'");
        ...
        <div id="content" class="fl-right">
            <div class="section" id="detail-page">
                <div class="section-detail">
                        ...
                        <form method="POST" action="?mod=users&controller=team&action=applyAdmin&page_id=<?php echo $page_num;?>&value=<?php if(!empty($value)){ echo $value;}?>">
                            <div class="actions">
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <ul id="list-paging" class="fl-right">
                        ...
                        <?php echo get_pagging($num_page, $page_num, "?mod=users&controller=team&action=resultSearch&value=".$value); ?>
                    </ul>
                </div>
            </div>
        </div>
