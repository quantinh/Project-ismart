...
$list_sliders = get_sliders($start, $num_per_page);

#Lấy danh sách trang
$list_num_page = db_num_page('tbl_sliders', $num_per_page);
...
$total_waiting = db_num_rows("SELECT * FROM `tbl_sliders` WHERE `slider_status` = 'Waiting...'");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="tbody-thumb">
                                                        <a href="?mod=sliders&controller=index&action=updateSlider&slider_id=<?php echo $slider['slider_id'] ?>"><img src="<?php if(!empty($slider['slider_thumb'])){echo $slider['slider_thumb'];} else{ echo 'public/images/avatar/img-product.png';}?>" alt=""></a>
                                                    </div>
                                                </td>
