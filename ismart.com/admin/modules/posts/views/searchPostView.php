...
$total_approved = db_num_rows("SELECT * FROM `tbl_posts` WHERE `post_status` = 'Approved' AND `post_title` LIKE '%$value%' OR `parent_cat` LIKE '%$value%'");

#Tổng bài viết chờ xét duyệt
$total_waiting = db_num_rows("SELECT * FROM `tbl_posts` WHERE `post_status` = 'Waiting...' AND `post_title` LIKE '%$value%' OR `parent_cat` LIKE '%$value%'");

#Tổng bài viết đã xóa
$total_trash = db_num_rows("SELECT * FROM `tbl_posts` WHERE `post_status` = 'Trash' AND `post_title` LIKE '%$value%' OR `parent_cat` LIKE '%$value%'");
