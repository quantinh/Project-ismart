...
#Mảng chưa tổng danh sách các phần tử 
...
$list_total = count($list_all_medias['admins']) + count($list_all_medias['posts']) + count($list_all_medias['products']) + count($list_all_medias['sliders']);
                        ...
                        <div class="table-responsive" id="table-scroller">
                            <?php if (!empty($list_all_medias)) { $error = array();?>
                                <table class="table list-table-wp">
                                    ...
                                    <tbody>
                                        <tr><td><h3 class="tbody-text">All admins</h3></td></tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="clearfix">
                                                    ...
                                                    <ul class="list-operation fl-right">
                                                        <li><a href="?mod=users&controller=team&action=updateAdmin&admin_id=<?php echo $list_admins['admin_id'] ?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                        ...
                                        <?php } ?>
                                        <tr><td><h3 class="tbody-text">All products</h3></td></tr>
                                        ...
                                        <?php $order_products = $order_admins; foreach ($list_all_medias['products'] as $list_products) { $order_products ++; ?>
                                            <tr>
                                                ...
                                                <td class="clearfix">
                                                    ...
                                                    <ul class="list-operation fl-right">
                                                        <li><a href="?mod=products&controller=index&action=updateProduct&product_id=<?php echo $list_products['product_id']?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                        ...
                                        <?php } ?>
                                        <tr><td><h3 class="tbody-text">All posts</h3></td></tr>
                                        ...
                                        <?php $order_posts = $order_products; foreach ($list_all_medias['posts'] as $list_posts) { $order_posts ++; ?>
                                            <tr>
                                                ...
                                                <td class="clearfix">
                                                    ...
                                                    <ul class="list-operation fl-right">
                                                        <li><a href="?mod=posts&controller=index&action=updatePost&post_id=<?php echo $list_posts['post_id']?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                        ...
                                        <?php } ?>
                                        <tr><td><h3 class="tbody-text">All sliders</h3></td></tr>
                                        ...
                                        <?php $order_sliders = $order_posts;  foreach ($list_all_medias['sliders'] as $list_sliders) { $order_sliders ++; ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="tbody-thumb">
                                                        <a href="?mod=sliders&controller=index&action=updateSlider&slider_id=<?php echo $list_sliders['slider_id'] ?>"><img src="<?php if(!empty($list_sliders['slider_thumb'])){echo $list_sliders['slider_thumb'];} else{ echo 'public/images/avatar/img-product.png';}?>" alt=""></a>
                                                    </div>
                                                </td>
                                                <td class="clearfix">
                                                    <div class="tb-title fl-left">
                                                    ...
                                                    <ul class="list-operation fl-right">
                                                        <li><a href="?mod=sliders&controller=index&action=updateSlider&slider_id=<?php echo $list_sliders['slider_id']?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
